...
const FormSchema = Yup.object().shape({
  fullname: Yup.string()
    .min(4, 'Nombre y apellido debe contener al menos 4 caracteres.')
    .max(60, 'Nombre y apellido debe contener al menos 4 caracteres')
    .required('Nombre y apellidos son requeridos'),
  email: Yup.string()
...
const EditProfile = () => {
  useDocumentTitle('Editar cuenta | Ployback');
  useScrollTop();
  ...
  return (
    <Boundary>
      <div className="edit-user">
        <h3 className="text-center">Editar cuenta - Detalles</h3>
        <Formik
